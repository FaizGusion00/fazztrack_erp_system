        ...
        <div class="p-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    {{-- Pola Link --}}
                    @if($job->order->pola_link)
                    <div class="space-y-4 mt-6">
                        <h4 class="text-sm font-medium text-gray-700 mb-3">Pola (Pattern) Link</h4>
                        <div class="border border-gray-200 rounded-lg p-4 bg-blue-50">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                    <i class="fas fa-ruler-combined text-blue-600 text-xl"></i>
                                    <div>
                                        <p class="text-sm font-medium text-gray-900">Grading Patterns (Multiple Sizes)</p>
                                        <p class="text-xs text-gray-500">Google Drive link for pola files</p>
                                    </div>
                                </div>
                                <a href="{{ $job->order->pola_link }}" 
                                   target="_blank" 
