                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">Google Drive link for pola files</p>
                                <p class="text-xs text-gray-400 mt-1 break-all">{{ $order->pola_link }}</p>
                            </div>
                        </div>
                        <a href="{{ $order->pola_link }}" 
                           target="_blank" 
